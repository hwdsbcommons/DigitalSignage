    ...
    foreach ($meta_box['fields'] as $field) {
        ...
        switch ($field['type']) {
            case 'text':
                ...
                '<input type="text" name="', $field['id'], '" id="', $field['id'], '" value="', $meta ? $meta : $field['std'], '" size="15" style="width:97%" />', '<br />', $field['desc'],
                '</div>';
                break;
            case 'ytvid':
                echo '<div style="width: 100%; clear:both;">',
                '<label for="', $field['id'], '">', $field['name'], '</label><br />',
                '<input type="text" maxlength="16" name="', $field['id'], '" id="', $field['id'], '" value="', $meta ? $meta : $field['std'], '" size="16" style="-webkit-border-top-left-radius: 0px!important;-webkit-border-top-left-radius: 0px!important;-moz-border-radius-topleft: 0;-webkit-border-bottom-left-radius: 0px!important;-webkit-border-bottom-left-radius: 0px!important;-moz-border-radius-bottomleft: 0;-moz-background-clip: padding;-webkit-background-clip: padding-box;background-clip: padding-box; margin: 10px 0; display: inline-block;" />', '<br />', $field['desc'],
                '</div>';
                break;
            case 'bgcolor':
                echo '<div style="width: 100%; clear:both;">',
...
//***********************
	function my_custom_login_logo() {
	    echo '<style type="text/css">
	        h1 a { background-image:url('.get_bloginfo('template_directory').'/login_page_logo.png) !important; overflow:visible !important; width:300px !important; height:135px !important; background-size:241px !important; }
	    </style>';
	}
